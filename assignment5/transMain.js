...
function setUpCamera() {
    ...
    glMatrix.mat4.lookAt(viewMatrix, [0, 0, -12], [0, 1, 0], [0, 1, 0]);
...
function drawShapes() {
    ...
    drawBase([0.0, 0.1, 0.0]);
    drawBase([3.0, 0.1, 0.0]);
    drawBase([-3.0, 0.1, 0.0]);
    modelMatrix = glMatrix.mat4.create();
    glMatrix.mat4.translate(modelMatrix, modelMatrix, [-3.0, 0.5, 0.0]);
...
function drawBase(position) {
    ...
    glMatrix.mat4.translate(modelMatrix, modelMatrix, position);
    glMatrix.mat4.scale(modelMatrix, modelMatrix, [1.5, 1.0, 1.5]);
    gl.uniformMatrix4fv(program.uModelT, false, modelMatrix);
