...
function setUpTextures(){
    ...
    if( curTexture == "myimage" ) {
        ...
        // load the actual image
        var dogeImage = document.getElementById('doge-texture')
        dogeImage.crossOrigin = "";        
        
        // load the texture data
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, dogeImage.width, dogeImage.height, 0, gl.RGBA, gl.UNSIGNED_BYTE, dogeImage);
...
function bindVAO (shape, program) {
  ...
  function init() {
    ...
    dogeProgram = initProgram('sphereMap-V', 'dogeMap-F');
